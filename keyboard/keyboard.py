...
if __name__ == '__main__':
    ...
    if os.getuid() != 0:
        ...
        sys.exit(os.system("/usr/bin/sudo /bin/su root -c '%s %s'" % (sys.executable, ' '.join(sys.argv))))
    print('Emulating: Keyboard')
    # Generic keyboard
    hid = HidDaemon(0x16c0, 0x0488, 'Validicity Sweden AB', 'Validicity Scanner Keyboard HID', 'fedcba9876543210', HIDReportDescriptorKeyboard)
    hid.run()