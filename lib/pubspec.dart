...
class Pubspec {
  static const String name = 'validicityclient';

  static const String description =
      'The client running on a Linux box scanning NFC tags';

  static const String versionFull = '0.1.0';

  static const String version = '0.1.0';

  static const String versionSmall = '0.1';
  ...
  static const Map<dynamic, dynamic> executables = <dynamic, dynamic>{
    'validicityclient': 'validicityclient',
  };
